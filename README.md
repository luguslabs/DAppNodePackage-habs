...
| `ARCHIPEL_TELEMETRY_URL` | Optional TELEMETRY_URL for Archipel substrate node. Example : `ws://BACKEND_PUBLIC_IP:8000/submit`. Can be an url list separated by `,` | empty or URL or `--no-telemetry` |
...
| `POLKADOT_TELEMETRY_URL` | Optional TELEMETRY_URL for Polkadot Node. Example : `ws://BACKEND_PUBLIC_IP:8000/submit`. Can be an url list separated by `,` | empty or URL or `--no-telemetry`|
